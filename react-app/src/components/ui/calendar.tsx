...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(10)] in-data-[slot=popover-content]:bg-transparent",
        className
      )}
      ...
      classNames={{
        ...
        caption_label: cn(
          "text-sm font-semibold capitalize text-foreground select-none",
