...
- [x] `FT-TODO-004` Расширить существующую архивацию счетов на страницу Инвестиций.  
...
- [x] `FT-TODO-007` Провести полный редизайн/полиш календаря.  
  **Критерий приемки:** календарный компонент визуально и UX-сценарно согласован с design-system на mobile и desktop.  
  **Статус:** выполнено 2026-02-19.

- [x] `FT-TODO-008` Провести полный редизайн/полиш выпадающих списков.  
