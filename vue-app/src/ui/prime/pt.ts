...
export const mergePt = <T extends object>(base: T, incoming?: PtInput): T => {
  ...
  for (const [key, incomingSection] of Object.entries(incoming as Record<string, PtSection | undefined>)) {
    ...
    result[key] = {
      ...baseSection,
      ...incomingSection,
      class: mergeClassNames(baseSection.class, incomingSection.class),
    };
  }
